...
namespace WebShop.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public ProductsController(WebShopContext context, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public async Task<ActionResult<Product>> Create([FromForm] Product product)
        {
            ...
            {
                string uploadsDir = Path.Combine(webHostEnvironment.WebRootPath,
                    "media/products");
